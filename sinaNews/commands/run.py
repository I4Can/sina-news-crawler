...
#     def syntax(self):
#         return "<classify> <database_name>"
#
#     def short_desc(self):
#         return "Crawl sina"
#
#     def long_desc(self):
#         return "Crawl sina rolling news data to a MySQL database."
#
...
#         parser.add_option("-c", "--classify", action="store_true", dest="good_only", default=False,
#                           help="only crawl good threads and their posts and comments")
#         parser.add_option("-f", "--full", type="str", dest="full", default="",
#                           help='Crawling the whole classify')
